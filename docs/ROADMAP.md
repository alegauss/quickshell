...
- 🛠 **QS96** (deps: QS12 ✅, QS95 ✅) **A third rasteriser shifts one antialiased pixel by six levels, which is three times the measured tolerance** — QS92 predicted this exact failure before any vendor driver had run, and named the shader rather than the tolerance as the thing to look at. → §QS96
