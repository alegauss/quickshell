...
- ⏳ **QS33** (deps: QS17 ✅, QS18 ✅, QS20 ✅, QS21 ✅, QS25 ✅) **No external suite has ever judged this emulator, so its fidelity is the author's own opinion** — vttest, which is interactive and older, so driving it without a person is its own piece of work. → §QS33
