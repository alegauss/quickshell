// The Markdown twin, converted from the same render (S5). The copy lives in the content
...
// the step numbers, the banner lock, the section kicker, terminal window bars, the legend.
