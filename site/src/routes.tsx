...
// https://alegauss.github.io/quickshell/, so canonical, og:url, the sitemap and every output
...
export type RouteMeta = {
  /** app path, leading slash: "/" or "/compare" */
  path: string;
  title: string;
  description: string;
  ogTitle: string;
...
// The metadata table. One row per route; the prerender reads it to patch each page's head.
// Adding a page is a row here AND a row in ROUTES below, and the assertion at the bottom of
// this module refuses either one on its own, at import time, in both directions.
...
// made loud at import: this throw fails tsc, the build or the prerender, whichever imports
// first.
