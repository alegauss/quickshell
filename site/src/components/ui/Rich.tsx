...
// Renders the tagged run list from the content module: plain text, inline <code>, <b> and
// <i>, without any markup parsing. The copy stays data, and the twin generator has a
// structure to walk rather than HTML to re-parse.
