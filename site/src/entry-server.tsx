...
/** The same component tree as clean static HTML, which is what the Markdown twin is
 *  converted from, so the twin cannot drift from the page: it is not authored twice. */
